...
FROM
(
    SELECT deviceid FROM knowyou_ott_edw.edw_mbh_deviceinfo WHERE date_time='${C_DAY}'
    GROUP BY deviceid
) a
-- 是否开机 
LEFT JOIN 
(
    ...
    WHERE date_time='${C_DAY}' AND active_state='1'
    GROUP BY deviceid
...
( 
    ...
    WHERE date_time='${C_DAY}' AND playstatus='开始'
    GROUP BY deviceid
...
(
    SELECT deviceid, count(*) AS play_num, round(sum(playTime)/3600, 1) AS play_duration
    FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
    WHERE date_time='${C_DAY}' AND playstatus='开始' AND videotype='直播'
    GROUP BY deviceid
...
(
    SELECT deviceid, count(*) AS play_num, round(sum(playTime)/3600, 1) AS play_duration
    FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
    WHERE date_time='${C_DAY}' AND playstatus='开始' AND videotype='点播'
    GROUP BY deviceid
...
(
    SELECT deviceid, count(*) AS play_num,round(sum(playTime)/3600, 1) AS play_duration
    FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
    WHERE date_time='${C_DAY}' AND playstatus='开始' AND videotype='回看'
    GROUP BY deviceid
...
(
    SELECT deviceid FROM knowyou_ott_edw.edw_mbh_devicestate 
    WHERE date_time<='${C_DAY}' AND date_time>='${C_MONTH}01' AND active_state='1'
    GROUP BY deviceid
) b ON a.deviceid =b.deviceid
...
( 
    SELECT deviceid,count(*) AS play_num,round(sum(playTime)/3600,1) AS play_duration
    FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
    WHERE date_time<='${C_DAY}' AND date_time>='${C_MONTH}01' AND playstatus='开始'
    GROUP BY deviceid
) c ON a.deviceid=c.deviceid
-- 当月收看直播\次数\时长
LEFT JOIN
(
    SELECT deviceid,count(*) AS play_num,round(sum(playTime)/3600,1) AS play_duration
    FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
    WHERE date_time<='${C_DAY}' AND date_time>='${C_MONTH}01' AND playstatus='开始' AND videotype='直播'
    GROUP BY deviceid
) d ON a.deviceid=d.deviceid 
-- 当月收看点播\次数\时长
LEFT JOIN
(
    SELECT deviceid,count(*) AS play_num,round(sum(playTime)/3600,1) AS play_duration
    FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
    WHERE date_time<='${C_DAY}' AND date_time>='${C_MONTH}01' AND playstatus='开始' AND videotype='点播'
    GROUP BY deviceid
) e ON a.deviceid=e.deviceid
-- 当月收看回播\次数\时长
LEFT JOIN
(
    SELECT deviceid,count(*) AS play_num,round(sum(playTime)/3600,1) AS play_duration
    FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
    WHERE date_time<='${C_DAY}' AND date_time>='${C_MONTH}01' AND playstatus='开始' AND videotype='回看'
    GROUP BY deviceid
) f ON a.deviceid=f.deviceid;
...
LEFT JOIN( 
    SELECT deviceid FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
    WHERE date_time='${C_DAY}' AND contentType='电视剧' AND playstatus='开始' AND videotype='点播'
    GROUP BY deviceid
)b ON a.key=b.deviceid
LEFT JOIN(
    SELECT deviceid FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
    WHERE date_time='${C_DAY}' AND contentType='电影' AND playstatus='开始' AND videotype='点播'
    GROUP BY deviceid
)c ON a.key=c.deviceid
LEFT JOIN(
    SELECT deviceid FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
    WHERE date_time='${C_DAY}' AND contentType='动漫' AND playstatus='开始' AND videotype='点播'
    GROUP BY deviceid
)d ON a.key=d.deviceid
LEFT JOIN(
    SELECT deviceid FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
    WHERE date_time='${C_DAY}' AND contentType='体育' AND playstatus='开始' AND videotype='点播'
    GROUP BY deviceid
)e ON a.key=e.deviceid
LEFT JOIN(
    SELECT deviceid FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
    WHERE date_time='${C_DAY}' AND (contentType='纪录片' OR contentType='纪实') AND playstatus='开始' AND videotype='点播'
    GROUP BY deviceid
)f ON a.key=f.deviceid
LEFT JOIN(
    SELECT deviceid FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
    WHERE date_time='${C_DAY}' AND contentType='教育' AND playstatus='开始' AND videotype='点播'
    GROUP BY deviceid
)g ON a.key=g.deviceid
LEFT JOIN(
    SELECT deviceid FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
    WHERE date_time='${C_DAY}' AND contentType='游戏' AND playstatus='开始' AND videotype='点播'
    GROUP BY deviceid
)h ON a.key=h.deviceid
LEFT JOIN(
    SELECT deviceid FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
    WHERE date_time='${C_DAY}' AND contentType='电竞' AND playstatus='开始' AND videotype='点播'
    GROUP BY deviceid
)i ON a.key=i.deviceid
LEFT JOIN(
    SELECT deviceid FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
    WHERE date_time='${C_DAY}' AND contentType='综艺' AND playstatus='开始' AND videotype='点播'
    GROUP BY deviceid
)j ON a.key=j.deviceid
LEFT JOIN(
    SELECT deviceid FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
    WHERE date_time='${C_DAY}' AND contentType='生活' AND playstatus='开始' AND videotype='点播'
    GROUP BY deviceid
)k ON a.key=k.deviceid
LEFT JOIN(
    SELECT deviceid FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
    WHERE date_time='${C_DAY}' AND contentType='少儿' AND playstatus='开始' AND videotype='点播'
    GROUP BY deviceid
)l ON a.key=l.deviceid 
LEFT JOIN(
    SELECT deviceid FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
...
LEFT JOIN(
    SELECT deviceid FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
    WHERE date_time='${C_DAY}' AND contentType='网剧' AND playstatus='开始' AND videotype='点播'
    GROUP BY deviceid
)f ON a.key=f.deviceid
LEFT JOIN(
    SELECT deviceid FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
    WHERE date_time='${C_DAY}' AND contentType='微电影' AND playstatus='开始' AND videotype='点播'
)g ON a.key=g.deviceid
LEFT JOIN(
    SELECT deviceid FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
    WHERE date_time='${C_DAY}' AND contentType='短视频' AND playstatus='开始' AND videotype='点播'
    GROUP BY deviceid
)h ON a.key=h.deviceid
LEFT JOIN(
    SELECT deviceid FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
...
LEFT JOIN(
    SELECT deviceid FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
    WHERE date_time='${C_DAY}' AND contentType='纪录片' AND playstatus='开始' AND videotype='点播'
    GROUP BY deviceid
)k ON a.key=k.deviceid
LEFT JOIN(
    SELECT deviceid FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
...
LEFT JOIN(
    SELECT deviceid FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
    WHERE date_time='${C_DAY}' AND contentType='音乐' AND playstatus='开始' AND videotype='点播'
    GROUP BY deviceid
)o ON a.key=o.deviceid 
LEFT JOIN(
    SELECT deviceid FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
    WHERE date_time='${C_DAY}' AND contentType='娱乐' AND playstatus='开始' AND videotype='点播'
    GROUP BY deviceid
)p ON a.key=p.deviceid 
LEFT JOIN(
    SELECT deviceid FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
    WHERE date_time='${C_DAY}' AND contentType='戏曲' AND playstatus='开始' AND videotype='点播'
    GROUP BY deviceid
)q ON a.key=q.deviceid 
LEFT JOIN(
    SELECT deviceid FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
...
LEFT JOIN( 
    SELECT deviceid FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
    WHERE date_time<='${C_DAY}' AND date_time>='${C_MONTH}01' AND contentType='电视剧' AND playstatus='开始' AND videotype='点播'
    GROUP BY deviceid
)b ON a.key=b.deviceid
LEFT JOIN(
    SELECT deviceid FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
    WHERE date_time<='${C_DAY}' AND date_time>='${C_MONTH}01' AND contentType='电影' AND playstatus='开始' AND videotype='点播'
    GROUP BY deviceid
)c ON a.key=c.deviceid
LEFT JOIN(
    SELECT deviceid FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
    WHERE date_time<='${C_DAY}' AND date_time>='${C_MONTH}01' AND contentType='动漫' AND playstatus='开始' AND videotype='点播'
    GROUP BY deviceid
)d ON a.key=d.deviceid
LEFT JOIN(
    SELECT deviceid FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
    WHERE date_time<='${C_DAY}' AND date_time>='${C_MONTH}01' AND contentType='体育' AND playstatus='开始' AND videotype='点播'
    GROUP BY deviceid
)e ON a.key=e.deviceid
LEFT JOIN(
    SELECT deviceid FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
    WHERE date_time<='${C_DAY}' AND date_time>='${C_MONTH}01' AND contentType='纪录片' AND playstatus='开始' AND videotype='点播'
    GROUP BY deviceid
)f ON a.key=f.deviceid
LEFT JOIN(
    SELECT deviceid FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
    WHERE date_time<='${C_DAY}' AND date_time>='${C_MONTH}01' AND contentType='教育' AND playstatus='开始' AND videotype='点播'
    GROUP BY deviceid
)g ON a.key=g.deviceid
LEFT JOIN(
    SELECT deviceid FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
    WHERE date_time<='${C_DAY}' AND date_time>='${C_MONTH}01' AND contentType='游戏' AND playstatus='开始' AND videotype='点播'
    GROUP BY deviceid
)h ON a.key=h.deviceid
LEFT JOIN(
    SELECT deviceid FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
    WHERE date_time<='${C_DAY}' AND date_time>='${C_MONTH}01' AND contentType='电竞' AND playstatus='开始' AND videotype='点播'
    GROUP BY deviceid
)i ON a.key=i.deviceid
LEFT JOIN(
    SELECT deviceid FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
    WHERE date_time<='${C_DAY}' AND date_time>='${C_MONTH}01' AND contentType='综艺' AND playstatus='开始' AND videotype='点播'
    GROUP BY deviceid
)j ON a.key=j.deviceid
LEFT JOIN(
    SELECT deviceid FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
    WHERE date_time<='${C_DAY}' AND date_time>='${C_MONTH}01' AND contentType='生活' AND playstatus='开始' AND videotype='点播'
    GROUP BY deviceid
)k ON a.key=k.deviceid
LEFT JOIN(
    SELECT deviceid FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
    WHERE date_time<='${C_DAY}' AND date_time>='${C_MONTH}01' AND contentType='少儿' AND playstatus='开始' AND videotype='点播'
    GROUP BY deviceid
)l ON a.key=l.deviceid 
LEFT JOIN(
    SELECT deviceid FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
...
(
    ...
    (
        ...
        (
            ...
            WHERE substr(a.createtime,1,8) >='${THIRTY_DAY}' AND substr(a.createtime,1,8)<='${C_DAY}'
        )c
...
(
    ...
    (
        SELECT deviceid FROM knowyou_ott_edw.edw_mbh_deviceinfo
        WHERE substr(createtime,1,6) >='${PRE_MONTH}'
        GROUP BY deviceid
    )a
    LEFT JOIN
    (
...
(
    ...
    (
        ...
        FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
        WHERE date_time='${C_DAY}' AND programname !='' AND playstatus='开始' AND videotype='直播' 
...
(
    ...
    (
        SELECT deviceid, programname AS videoname, sum(playTime) AS play_duration 
        FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
        WHERE date_time='${C_DAY}' AND programname !='' AND playstatus='开始' AND videotype='点播' 
        GROUP BY deviceid, programname
    )a 
    WHERE a.play_duration<3600
)t0
...
(
    ...
    (
        ...
        FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
        WHERE actionpath regexp('.*搜索.*') AND videotype='点播' AND date_time='${C_DAY}' AND programname<>"" 
    ...
    (
        ...
        FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
        WHERE actionpath regexp('.*搜索.*') AND videotype='点播' AND substr(date_time,1,6)='${C_MONTH}' AND programname<>"" 
        GROUP BY programname
        ORDER BY playnum desc
        limit 10
    )ff
    ...
    (
        ...
        FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer 
        WHERE actionpath regexp('.*收藏.*') AND videotype='点播' AND date_time='${C_DAY}' AND programname<>"" 
        GROUP BY programname
        ORDER BY playnum desc
        limit 10
    )ff
    ...
    (
        ...
        FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer 
        WHERE actionpath regexp('.*收藏.*') AND videotype='点播' AND substr(date_time,1,6)='${C_MONTH}' AND programname<>"" 
        GROUP BY programname
        ORDER BY playnum desc
        limit 10
    )ff
...
(
    ...
    (
        SELECT
            ...
            programClass
        FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer 
        WHERE date_time='${C_DAY}' AND videotype ='点播' AND playstatus='开始'
...
(    
    ...
    (
        select * from knowyou_yst_ods.ods_pd_usertv_info_d where stat_date = '${C_DAY}'
    ) a
    join 
    (
        select device_id, broadband_id from knowyou_yst_ods.ods_userbox_info_d 
        where stat_date = '${C_DAY}' and device_id is not null
...
(
    ...
    (
        ...
        WHERE deal_date_p='${C_DAY}' AND PROD_PRC_NAME IN ('VIP影视','电视黄金会员包','酷喵影视','VIP影视合约包','酷喵影视合约包','影视组合包','环球影视','乐享影视','精彩视界','VIP影视半年包','VIP影视（酒店）','VIP影视5折包','新星影视','欢TV','乐享影视5折包','VIP影视15元合约包（24个月）','家庭电视VIP畅享组合包','土豆影视','超人系列超人影院','超人系列超人动漫','环球影视5折包','影视组合包5折包','VIP影视年包','新星影视5折包','环球影视特价包')
...
(
    ...
    (
        SELECT USER_IDENTITY FROM knowyou_ott_dmt.tb_mid_pdt_nettv_user_day
        WHERE deal_date_p='${C_DAY}' AND PROD_PRC_NAME IN ('VIP少儿','影视少儿频道包','VIP少儿合约包','奇趣星球','看视少儿','拉贝少儿','狐趣星球','炫力动漫','智趣尊享包','爱看视界少儿学堂','快乐城堡开心乐园','嘟嘟玩具王国','家有萌宝','儿童乐园','少儿组合包','宝宝乐园','迪士尼','嗨皮城堡','快乐宝贝','超级萌童','淘淘玩具屋','泡泡玩乐屋','VIP少儿半年包','叮当动漫','拉贝少儿5折包','VIP少儿5折包','知了乐园','优宝乐园','童趣漫游','童学优漫','玩具乐园','乐学星空','快乐佳贝','童趣漫游5折包','儿童乐园5折包','童画绘本','少儿天地','童学优漫5折包','看视少儿5折包','少儿组合包5折包','迪士尼专区5折包','VIP少儿年包','幺儿乐知堂','优优乐园','小小少儿','奇异乐园','橙子乐园','启蒙快乐包')
        GROUP BY USER_IDENTITY
    )t1 ON t0.deviceid=t1.USER_IDENTITY
    WHERE t1.USER_IDENTITY is null
...
set hive.exec.dynamic.partition=true;
set hive.exec.dynamic.partition.mode=nonstrict;
INSERT OVERWRITE TABLE knowyou_ott_dmt.htv_stock_order PARTITION(date_time='${C_DAY}')
SELECT
...
(
    ...
    (
        SELECT deviceid FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
        WHERE date_time='${C_DAY}' AND (contentType='电视剧' OR contentType='电影') AND playstatus='开始' AND videotype='点播'
        GROUP BY deviceid
    ) t0
    LEFT JOIN 
    (
        SELECT USER_IDENTITY FROM knowyou_ott_dmt.tb_mid_pdt_nettv_user_day
        WHERE deal_date_p='${C_DAY}' AND PROD_PRC_NAME IN ()
        GROUP BY USER_IDENTITY
    ) t1 ON t0.deviceid = t1.USER_IDENTITY
) a
FULL JOIN
(
    ...
    (
        SELECT USER_IDENTITY FROM knowyou_ott_dmt.tb_mid_pdt_nettv_user_day
        WHERE deal_date_p='${C_DAY}' AND PROD_PRC_NAME IN ('魔百和-少儿包包月10元','IPTV-少儿包包月15元','IPTV少儿30天18元','IPTV少儿包季39.9元','IPTV少儿包半年78.8元','IPTV少儿包年')
        GROUP BY USER_IDENTITY
    ) t1 ON t0.deviceid = t1.USER_IDENTITY
) c ON a.deviceid = c.deviceid
FULL JOIN
...
(
    ...
    (
        SELECT deviceid FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
        WHERE date_time='${C_DAY}' AND playstatus='开始' AND videotype='点播' AND contentType!='电视剧' AND contentType!='电影' 
...
ELSE 1 END)  AS hourtype -- 小时段分类 
FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer
WHERE date_time>'${Y_DAY}' AND date_time <'20220602'  --近一个月
...
FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer 
WHERE date_time>'${Y_DAY}' AND date_time <'20220602' AND listsubtype!='' AND listsubtype IS NOT NULL 
)a 
...
SELECT luacpversion,collect_set(listsubtype) FROM knowyou_ott_ods.ods_mbh_userbehavior_buffer WHERE date_time>='${C_DAY}' GROUP BY luacpversion
