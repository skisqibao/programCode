...
CREATE TABLE knowyou_ott_dmt.`htv_demand_column_prefer_dm`(
  `deviceid`                 STRING COMMENT '设备id', 
  `demand_type_prefer_lv1`   STRING COMMENT '当日电视剧栏目偏好', 
  `demand_type_prefer_lv2`   STRING COMMENT '当日电影栏目偏好', 
  `demand_type_prefer_lv3`   STRING COMMENT '当日动漫栏目偏好', 
  `demand_type_prefer_lv4`   STRING COMMENT '当日体育栏目偏好', 
  `demand_type_prefer_lv5`   STRING COMMENT '当日纪录片栏目偏好', 
  `demand_type_prefer_lv6`   STRING COMMENT '当日教育影栏目偏好', 
  `demand_type_prefer_lv7`   STRING COMMENT '当日游戏频栏目偏好', 
  `demand_type_prefer_lv8`   STRING COMMENT '当日电竞栏目偏好', 
  `demand_type_prefer_lv9`   STRING COMMENT '当日综艺栏目偏好', 
  `demand_type_prefer_lv10`  STRING COMMENT '当日生活片栏目偏好', 
  `demand_type_prefer_lv11`  STRING COMMENT '当日少儿栏目偏好',
  `demand_type_prefer_other` STRING COMMENT '当日其他栏目偏好')
COMMENT '当日点播栏目偏好标签表'
PARTITIONED BY (`date_time` STRING COMMENT '日期')
ROW FORMAT SERDE  'org.apache.hadoop.hive.serde2.lazy.LazySimpleSerDe' 
STORED AS INPUTFORMAT  'org.apache.hadoop.mapred.TextInputFormat' 
...
CREATE TABLE knowyou_ott_dmt.`htv_demand_column_prefer_dm_month`(
  `deviceid`                 STRING COMMENT '设备id', 
  `demand_type_prefer_lv1`   STRING COMMENT '当月电视剧栏目偏好', 
  `demand_type_prefer_lv2`   STRING COMMENT '当月电影栏目偏好', 
  `demand_type_prefer_lv3`   STRING COMMENT '当月动漫栏目偏好', 
  `demand_type_prefer_lv4`   STRING COMMENT '当月体育栏目偏好', 
  `demand_type_prefer_lv5`   STRING COMMENT '当月纪录片栏目偏好', 
  `demand_type_prefer_lv6`   STRING COMMENT '当月教育影栏目偏好', 
  `demand_type_prefer_lv7`   STRING COMMENT '当月游戏频栏目偏好', 
  `demand_type_prefer_lv8`   STRING COMMENT '当月电竞栏目偏好', 
  `demand_type_prefer_lv9`   STRING COMMENT '当月综艺栏目偏好', 
  `demand_type_prefer_lv10`  STRING COMMENT '当月生活片栏目偏好', 
  `demand_type_prefer_lv11`  STRING COMMENT '当月少儿栏目偏好',
  `demand_type_prefer_other` STRING COMMENT '当月其他栏目偏好')
COMMENT '当月点播栏目偏好标签表'
PARTITIONED BY (`date_time` STRING COMMENT '日期')
ROW FORMAT SERDE  'org.apache.hadoop.hive.serde2.lazy.LazySimpleSerDe' 
STORED AS INPUTFORMAT  'org.apache.hadoop.mapred.TextInputFormat' 
...
CREATE TABLE knowyou_ott_dmt.`htv_adduserretentionlabe_dm`(
  `deviceid`          STRING COMMENT '设备id', 
  `morrow_adduser`    STRING COMMENT '次日新增留存用户', 
  `seven_adduser`     STRING COMMENT '7日新增留存用户', 
  `fourteen_adduser`  STRING COMMENT '14日新增留存用户', 
  `thirty_adduser`    STRING COMMENT '30日新增留存用户')
COMMENT '用户新增留存标签日表'
PARTITIONED BY (`date_time` STRING COMMENT '日期')
ROW FORMAT SERDE  'org.apache.hadoop.hive.serde2.lazy.LazySimpleSerDe' 
STORED AS INPUTFORMAT  'org.apache.hadoop.mapred.TextInputFormat' 
...
CREATE TABLE knowyou_ott_dmt.htv_directorlabel_dm(
    deviceid     STRING COMMENT '设备id'
    directorname STRING COMMENT '导演'
)
COMMENT '导演分类媒资标签'
PARTITIONED BY (`date_time` STRING COMMENT '日期')
ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.lazy.LazySimpleSerDe' 
...
(
    deviceid    STRING  COMMENT '设备id',
    film        STRING  COMMENT '电影每日新增订购',
    child       STRING  COMMENT '少儿每日新增订购',
    comic       STRING  COMMENT '动画每日新增订购',
    esport      STRING  COMMENT '电竞每日新增订购',
    game        STRING  COMMENT '游戏每日新增订购',
    edu         STRING  COMMENT '教育每日新增订购',
    health      STRING  COMMENT '健康每日新增订购',
    life        STRING  COMMENT '生活每日新增订购',
    sport       STRING  COMMENT '体育每日新增订购',
    platform    STRING  COMMENT '平台每日新增订购',
    music       STRING  COMMENT '音乐每日新增订购',
    other       STRING  COMMENT '其他每日新增订购'
)
COMMENT '每日新增订购按栏目分类'
PARTITIONED BY (`date_time` STRING COMMENT '日期')
ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.lazy.LazySimpleSerDe' 
...
CREATE TABLE IF NOT EXISTS knowyou_ott_dmt.htv_arpu_dm
(
