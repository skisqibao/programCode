...
//import org.apache.logging.l og4j.core.util.KeyValuePair;
    ...
    static {
        try {
            if (conf == null) {
                ...
                conf.set("hbase.master.kerberos.principal", "hbase/_HOST@SXMCC.COM");
                conf.set("hbase.regionserver.kerberos.principal", "hbase/_HOST@SXMCC.COM");
                conf.set("hbase.rest.kerberos.principal", "hbase/_HOST@SXMCC.COM");
                conf.set("hbase.thrift.kerberos.principal", "hbase/_HOST@SXMCC.COM");

                conf.set("keytab.file" , "aispark.keytab" );
                conf.set("kerberos.principal" , "hbase/_HOST@SXMCC.COM" );
...
//                for (KeyValue kv: result.listCells()) {
